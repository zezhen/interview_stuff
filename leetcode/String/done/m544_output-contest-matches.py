...
class Solution(object):
    def findContestMatch(self, n):
        ...
        teams = map(str, range(1, n+1))
        rd = math.log(n, 2)
        rd = (1 if rd > int(rd) else 0) + int(rd)

        while rd > 0:
            l, r = 0, n - 1
            while l < r:
                pair = "(%s,%s)" % (teams[l], teams[r])
                teams[l] = pair
                l += 1
                r -= 1
...
assert s.findContestMatch(6) == '(((1,6),(3,4)),(2,5))'
assert s.findContestMatch(8) == '(((1,8),(4,5)),((2,7),(3,6)))'
assert s.findContestMatch(10) == '((((1,10),(5,6)),(3,8)),((2,9),(4,7)))'
