...
s = Solution()
assert s.findCheapestPrice(3, [[0,1,100],[1,2,100],[0,2,500]], 2, 1, 2) == -1
...
assert s.findCheapestPrice(3, [[0,1,100],[1,2,100],[0,2,500]], 1, 2, 1) == 100
assert s.findCheapestPrice(3, [[0,1,100],[1,2,50],[0,2,500],[1,3,200],[2,3,30],[0,3,200]], 0, 3, 2) == 180